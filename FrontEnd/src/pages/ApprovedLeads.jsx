...
import { Search, MoreVertical, RefreshCw, Eye, ChevronDown } from "lucide-react";
                  ...
                  filteredLeads.map((lead) => (
                    <tr key={lead._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${getStatusBadge(lead.lead_status)}`}>
